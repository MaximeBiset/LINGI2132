...
/**
 *  The AST node for the division (/) expression
 */
...
{
	/**
	 * Construct and AST node for a modulo expression
	 * given its line number, the lhs and the rhs operands.
	 * 
	...
	/**
	 * Generating code for the % operation involves generating code
	 * for the two operands, and then the modulo instruction.
	 * 
	 * @param output the code emitter (basically an abstraction for
	 * producing the class file
	 */
...
{
	/**
	 * Construct an AST node for a left shift expression
	 * given its line number, and the lhs and rhs operands.
	 * 
	 * @param line lin in which the shift expression
	 * occurs in the source file.
	 * @param lhs lhs operand.
	 * @param rhs rhs operand.
	 */
	
	protected JLeftShiftOp(int line, JExpression lhs, JExpression rhs)
	{
		super(line, "<<", lhs, rhs);
	}
	...
	/**
	 * Generating code for the "<<" operation involves generating code
	 * for the two operands, and then the shift instruction.
	 * 
	 * @param output the code emitter (basically an abstraction for
	 * producing the .class file).
	 */
...
{
	/**
	 * Construct an AST node for a right shift expression
	 * given its line number, and the lhs and rhs operands.
	 * 
	 * @param line line in which the shift expression
	 * occurs in the source file
	 * @param lhs lhs operand.
	 * @param rhs rhs operand.
	 */
	protected JRightShiftOp(int line, JExpression lhs, JExpression rhs)
	{
		super(line, ">>", lhs, rhs);
	}
	...
	/**
	 * Generating code for the >> operation involves generating code
	 * for the two operands, and the division instruction.
	 * 
	 * @param output the code emitter (basically an abstraction for
	 * producing the .class file).
	 */
