...
public class Parser {
    ...
    private JExpression relationalExpression() {
        ...
        if (have(GT)) {
        	...
        	return new JLessOp(line, lhs, additiveExpression());
     ...
     *                                  {(DIV | STAR | MOD | LSHIFT | RSHIFT) unaryExpression}
     * </pre>
     * 
    ...
    private JExpression multiplicativeExpression() {
        ...
        while (more) {
            if (have(STAR)) {
            	...
            	lhs = new JRightShiftOp(line, lhs, unaryExpression());
            } else if (have(LSHIFT)) {
            	lhs = new JLeftShiftOp(line, lhs, unaryExpression());
            } else {
                more = false;
            }
        }
